...
var likeState = {
  ...
  icon: {
    ...
    '32': './images/heart_32.png',
    '64': './images/heart_64.png'
  }
};
...
var unlikeState = {
  label: "Don't like",
  icon: {
    '16': './images/heart_active_16.png',
    '32': './images/heart_active_32.png',
    '64': './images/heart_active_64.png'
  }
};
...
function createLike(tab) {
  ...
  Request({
    ...
    content: JSON.stringify({ like: { url: tab.url, title: tab.title } }),
  }).post();
}
